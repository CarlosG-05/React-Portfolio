...
import finishedPCB from "../images/finishedPCB.png";
import '../styles/Projects.css';

const projects = {
    ampEq: {
        title: "Equalizer & Amplifier",
        date: "June - September 2025",
        description: "Completed a full design, simulation, and PCB layout for a 3-band active audio equalizer with an integrated power amplifier.",
        siteLink: "EqAmpReport.pdf", // Link to PDF in public folder
        image: finishedPCB,
        id: 1
    },
    medhome: {
        ...
        <div className="projects-grid">
            {Object.values(projects).map((project) => (
                <Project
                    ...
                    openPdf={project.siteLink.endsWith('.pdf')}
                />
            ))}
        </div>
    );
